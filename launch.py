...
def get_weight_filenames(dataset_name):
    ...
    return wl_embedder_file, graph_embedder_file
...
def train_dense(dataset_name, max_depth, num_heads, num_features, k, num_batchs, num_epochs):
    ...
    wl_embedder_file, graph_embedder_file = get_weight_filenames(dataset_name)
...
if __name__ == '__main__':
    ...
    if args.task in available_tasks:
        train_dense(args.task, max_depth=2, num_heads=4, num_features=64, k=5, num_batchs=100, num_epochs=20)
    else:
