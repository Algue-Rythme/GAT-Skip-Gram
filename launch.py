...
def train_dense(dataset_name, extractor, max_depth, num_features, k, num_epochs):
...
if __name__ == '__main__':
    ...
    if args.task in available_tasks:
        train_dense(args.task, extractor='gcn', max_depth=4, num_features=256, k=1, num_epochs=30)
    else:
